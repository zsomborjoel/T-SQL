...
BEGIN TRY 
	...
	R.MEGJEGYZÉS
	FROM RENDELÉS AS R 
	JOIN RENDELÉS_ÁR_AJÁNLAT AS RÁ ON R.RENDELÉS_ID=RÁ.RENDELÉS_ID
	LEFT JOIN ENTITÁS AS E ON R.ENTITÁS_ID = E.ENTITÁS_ID
	LEFT JOIN ENTITÁS_SZEGMENS AS ESZ ON E.ENTITÁS_SZEGMENS_ID = ESZ.ENTITÁS_SZEGMENS_ID
	LEFT JOIN TERMÉK AS T ON RÁ.TERMÉK_ID = T.TERMÉK_ID
	LEFT JOIN TERMÉK_MINŐSÉG_ÁR AS TMÁ ON T.TERMÉK_ID=TMÁ.TERMÉK_ID
	GROUP BY 
	RENDELÉS_KÓD,	
	ENTITÁS_KÓD,
	TELJES_NÉV,	
